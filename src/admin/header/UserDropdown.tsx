...
export default function UserDropdown() {
  ...
  return (
    <div className="relative">
      ...
      >
        <span className="mr-3 overflow-hidden rounded-full h-11 w-11 bg-[#EDE9FE] flex items-center justify-center">
          {profile.full_name ? (
            <span className="text-[#7C3AED] font-bold text-sm">{initials}</span>
          ) : (
      ...
      <Dropdown
        ...
        className="absolute right-0 mt-[17px] flex w-[260px] flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-400 dark:bg-gray-800"
      >
        {/* Profile Info */}
        <div className="flex items-center gap-3 pb-3 border-b border-gray-100 dark:border-gray-700">
          <div className="w-10 h-10 rounded-full bg-[#EDE9FE] flex items-center justify-center text-[#7C3AED] font-bold text-sm shrink-0">
            {initials}
          </div>
          <div>
            ...
            {profile.role && (
              <span className="inline-block mt-0.5 px-2 py-0.5 text-[10px] font-semibold bg-red-100 text-red-600 rounded-full capitalize">
                {profile.role}
              </span>
            )}
          </div>
        ...
        <ul className="flex flex-col gap-1 pt-3 pb-3 border-b border-gray-200 dark:border-gray-800">
          <li>
            ...
            >
              <svg className="fill-gray-500 group-hover:fill-gray-700" width="20" height="20" viewBox="0 0 24 24">
        ...
        <button
          ...
          className="flex items-center gap-3 px-3 py-2 mt-3 font-medium text-gray-700 rounded-lg group text-theme-sm hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 w-full text-left disabled:opacity-50 disabled:cursor-not-allowed transition-opacity"
        >
          <svg className="fill-gray-500 group-hover:fill-gray-700" width="24" height="24" viewBox="0 0 24 24">
