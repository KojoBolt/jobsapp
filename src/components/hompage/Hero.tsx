                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                        <div className="text-left">
                            ...
                            >
                                ...
                                Our AI scans thousands of jobs and matches you with the best opportunities 
                            ...
                            >
                                ...
                                <div className="flex items-center gap-2 p-2 px-3 sm:px-6.5 hover:bg-white/3 transition-colors">
                                    ...
                                    <div>
                                        <div>Just smart job matches</div>
                                        <div className="text-xs text-gray-400">
                                            Ai writes your cover letter too
                                        </div>
                                    </div>
                                </div>
                            </motion.div>
                        ...
                        >
                            <motion.div className="rounded-3xl overflow-hidden border border-white/6 shadow-2xl bg-gradient-to-b from-black/50 to-transparent">
